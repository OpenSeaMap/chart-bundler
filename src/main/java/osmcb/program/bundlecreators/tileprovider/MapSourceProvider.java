...
public class MapSourceProvider implements IfTileProvider
{
	 ...
	 * @param zoom
	 * @param loadMethod
	 *          defines if the tile should be taken from tile cache or from it's original source (web server, generated...).
	 */
	public MapSourceProvider(IfMapSource mapSource, int zoom, LoadMethod loadMethod)
	{
		super();
