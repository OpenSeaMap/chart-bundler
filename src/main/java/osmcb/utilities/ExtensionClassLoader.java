...
import osmb.utilities.file.RegexFileFilter;
...
public class ExtensionClassLoader extends URLClassLoader
{
	...
	/**
	 * Creates an {@link ExtensionClassLoader} for loading JARs at runtime that have JNI dependencies.
	 * 
	 * @param dirList
	 *          list of directories to search in. The first directory containing at least one jar matching the <code>regexFilePattern</code> is taken. The other
	 *          directories are ignored.
	 * @param regexFilePattern
	 *          jar/jni regex search pattern
	 * @return The {@link ClassLoader} that is able to load classes from the loaded JARs and the correspondant JNI libraries
